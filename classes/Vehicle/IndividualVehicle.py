...
class IndividualVehicle(Vehicle):

    def __init__(self, vehicle_type: IndividualVehicleType, propulsion_type: PropulsionType=None, location: Location = None,
                 ):
        self.__vehicle_type = vehicle_type
        self.__propulsion_type = propulsion_type
        self.__location = location

    def get_vehicle_type(self) -> IndividualVehicleType:
